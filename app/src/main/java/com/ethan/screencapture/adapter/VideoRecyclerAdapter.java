...
import com.ethan.screencapture.encoder.Mp4toGIFConverter;
import com.ethan.screencapture.fragment.VideosListFragment;
...
public class VideoRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            case VIEW_ITEM:
                ...
                itemViewHolder.overflow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        popupMenu.inflate(R.menu.video_popupmenu);
                        popupMenu.show();
    ...
    private void deleteVideos(ArrayList<Integer> positions) {
      ...
      int temp = 0;
        ...
        video = new File(videos.get(positions.get(position)-temp).getFile().getPath());
       if (video.delete()) {
            videos.remove(positions.get(position) - temp);
            temp++;
          }
        }
        notifyDataSetChanged();
    ...
    private void confirmDelete(final int position) {
        new AlertDialog.Builder(context)
                .setTitle(context.getResources().getQuantityString(R.plurals.delete_video_title, 1))
                .setMessage(context.getResources().getQuantityString(R.plurals.delete_video_message, 1))
                .setCancelable(false)
    ...
    private void confirmDelete(final ArrayList<Integer> positions) {
        ...
        new AlertDialog.Builder(context)
                .setTitle(context.getResources().getQuantityString(R.plurals.delete_video_title, count))
                .setMessage(context.getResources().getQuantityString(R.plurals.delete_video_message,
                        count, count))
                .setCancelable(false)
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    @Override
