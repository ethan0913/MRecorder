...
import com.ethan.screencapture.BuildConfig;
import com.ethan.screencapture.Const;
import com.ethan.screencapture.PermissionResultListener;
import com.ethan.screencapture.PrivacyPolicy;
import com.ethan.screencapture.R;
import com.ethan.screencapture.fragment.ScreenShotFragment;
import com.ethan.screencapture.fragment.SettingsPreferenceFragment;
import com.ethan.screencapture.fragment.ToolsFragment;
...
public class MainActivity extends AppCompatActivity implements PermissionResultListener {
    ...
    private Intent ballIntent;

    @TargetApi(23)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ActivityStackManager.getActivityManager().addActivity(this);
        ballIntent = new Intent(MainActivity.this, FloatBallService.class);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        int page = intent.getIntExtra(Const.INTENT_PAGE_CODE,0);
        viewPager.setCurrentItem(page);
//        if ("list".equals(intent.getStringExtra("list"))) {
//            // 切换到列表页面
...
//        getMenuInflater().inflate(R.menu.overflow_menu, menu);
    ...
    class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            //added by wangxl fragment在切换时不会销毁并重新创建
