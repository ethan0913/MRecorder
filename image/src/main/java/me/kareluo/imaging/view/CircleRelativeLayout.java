...
/**
 * Created by lizh16 on 2018/5/15.
 */
...
public class CircleRelativeLayout extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.ImageCircleRelativeLayoutLayout);
        color = array.getColor(R.styleable.ImageCircleRelativeLayoutLayout_image_background_color,0X0000000);
        alpha = array.getInteger(R.styleable.ImageCircleRelativeLayoutLayout_image_background_alpha,100);
        setColors();
        array.recycle();
    }
    @Override
